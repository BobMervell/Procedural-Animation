...
var _grounded_legs:Array[ThreeSegmentLeg]
## list of legs returning to resting position
var _returning_legs:Array[ThreeSegmentLeg]
## list of first diagonal legs
var _diagonal_legs_1:Array[ThreeSegmentLeg]
## list of second diagonal legs
var _diagonal_legs_2:Array[ThreeSegmentLeg]
...
func _initiate_controller() -> void:
	...
	for leg:ThreeSegmentLeg in _grounded_legs:
...
func _get_leg_heights() -> void:
	for leg:ThreeSegmentLeg in _leg_heights:
...
func _update_legs_variables(delta:float) -> void:
	...
	for leg:ThreeSegmentLeg in _get_returning_pair():
	...
	for leg:ThreeSegmentLeg in _returning_legs:
		if movement_dir != Vector3.ZERO: leg.movement_dir = movement_dir
		_return_to_rest(leg,delta)

## get leg pair which needs the most a restep
func _get_returning_pair() -> Array[ThreeSegmentLeg]:
...
func _return_to_rest(leg:ThreeSegmentLeg,delta:float) -> void:

...
func _enter_tree():
	...
	add_custom_type("RadialQuadripedController","CharacterBody3D",preload("res://addons/ProceduralAnimation/BodiesController/RadialQuadripedController.gd"),
		preload("res://addons/ProceduralAnimation/BodiesController/radial_quadriped_icon.png"))
	add_custom_type("TEST","Node3D",preload("res://test.gd"),
		preload("res://addons/ProceduralAnimation/BodiesController/radial_quadriped_icon.png"))
...
"res://addons/ProceduralAnimation/BodiesController/RadialQuadripedController.gd"
